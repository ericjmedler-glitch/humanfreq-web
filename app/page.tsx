...
const PANELS: Array<{
  ...
  // Panel 5 — Mug
  {
    ...
    alt: "Morning coffee — Human Frēq mug",
  ...
  // Panel 6 — Bottle
  {
    ...
    body: "A few weeks ago I started drinking a gallon of water a day. Sounds simple. But somewhere in there I noticed something I didn't expect, that good water out of a good bottle just feels better. So that's the bottle I went and found. Because what you put in your body matters, and the small stuff turns out to be the big stuff.",
    textPosition: "left",
  ...
  // Panel 8 — Tee / Garden (closing panel)
  {
    ...
    alt: "Human Frēq tee — garden setting",
    ...
    >
      ...
      <div className="hf-panel-media">
        ...
        <div className="hf-panel-mobile-only">
          <div style={{ position: "absolute", bottom: "160px", left: 0, width: "82%", maxWidth: "380px", padding: "0 20px" }}>
            ...
            <h1 style={{ color: "var(--color-hero-text)", fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "clamp(1.65rem, 6vw, 2.4rem)", fontWeight: 300, lineHeight: 1.3, margin: 0 }}>
              A human being can do remarkable things.{" "}
              <em>But when doing begins to replace being, it&rsquo;s time to come back.</em>
            </h1>
          </div>
          <PanelCTA isHero />
        </div>
      ...
      <div className="hf-panel-desktop-col">
        <div className="hf-panel-desktop-inner">
          ...
          <h1 style={{ color: "var(--color-hero-text)", fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "clamp(1.8rem, 2.5vw, 2.9rem)", fontWeight: 300, lineHeight: 1.3, margin: "0 0 2rem" }}>
            A human being can do remarkable things.{" "}
            <em>But when doing begins to replace being, it&rsquo;s time to come back.</em>
          </h1>
...
function WelcomePanel() {
  ...
  const p4 = "Everything's made to feel good on, the kind of soft you reach for without thinking. Built around the idea of the book: that coming back to yourself is worth making room for.";
    ...
    >
      <div style={{ maxWidth: "480px", margin: "0 auto", width: "100%" }}>
        ...
        <p style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontSize: "1.18rem", lineHeight: 1.65, marginBottom: "1.75rem" }}>
          I&rsquo;m building this in the open. The book, the collection, wherever this goes. I&rsquo;ll only reach out when there&rsquo;s something worth sharing.
        </p>
        <EmailCapture />
